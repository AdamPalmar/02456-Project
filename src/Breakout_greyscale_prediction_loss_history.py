...
train_frames = np.empty(shape=(num_epochs, image_size, image_size, frame_stack_size))
# -------------------------#
...
encoder = Convolution2D(16, filter_size, filter_size, activation=activation, border_mode=border)(encoder)
...
for _ in range(100):
    ...
    for i in range(num_epochs):
        ...
        if frame_counter == frame_stack_size + 1:
            ...
            resized_img[image_counter] = diff_image.reshape((image_size, image_size, 1))
            ...
            train_frames[image_counter] = three_frame_stack[:, :, :,
                           start:end]
